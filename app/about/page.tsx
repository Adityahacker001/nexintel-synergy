  ...
  return (
    <>
      <div className="fixed inset-0 -z-10 w-full h-full">
        <img
          src="/photo-1517816743773-6e0fd518b4a6.jpeg"
          alt="Background"
          className="w-full h-full object-cover"
        />
        <div className="absolute inset-0 bg-black/60" />
      </div>
      <section id="about" className="pt-32 pb-20 bg-transparent px-2 md:px-8">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div className="text-white space-y-8">
                <div>
                  <h2 className="text-4xl md:text-5xl font-light mb-6 leading-tight text-white">
                    ...
                    <span className="block text-white font-bold">Intelligent Technology</span>
                  </h2>
                  <p className="text-md text-white leading-relaxed mb-8">
              ...
              <div className="relative flex items-center justify-center">
                <div className="absolute inset-0 rounded-lg bg-white" style={{ opacity: 1 }}></div>
                <img
                  src="/logo-2.png"
